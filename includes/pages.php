...
backdrop-filter: blur(2px);
    z-index: 999; /* Certifique-se de que a sobreposição está acima de outros elementos */
}
   ...
   <img id="imagem-comemorativa" src="../../includes/barra/nivel.png" alt="Imagem Comemorativa" style="display: none;">
   ';
         echo "</div>";
