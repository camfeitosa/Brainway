...
if (isset($payload['email'])) {
    ...
    if ($row['count'] == 0) {
        ...
        $sql = "INSERT INTO usuario (id_user, usuario, nome, email, senha, data_cad, moedas, avatar, nivel) VALUES (null, null ,'$name', '$email', '', '$data_cad', '$moedas','../loja/personagens/m12.png' ,'$nivel')";
