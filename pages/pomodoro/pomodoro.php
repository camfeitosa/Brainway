<!DOCTYPE html>
<html lang="pt-br" > <!-- difine a cor de fundo padrão-->
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="pages/pomodoro/style.css">
    <script src="pages/pomodoro/script.js" defer></script>
</head>
    ...
    <main class="app">
        ...
        <section class="app__section-card-container">
            <div class="app__card">
                ...
                <!-- Mudar a cor de acordo com os botões -->
                <ul data-contexto="foco" class="app__card-list">
                    <li class="app__card-list-item" data-contexto="foco">
                        <button data-contexto="foco" class="app__card-button app__card-button--foco active">Foco</button>
                    </li>
                    <li class="app__card-list-item">
                        <button data-contexto="short" class="app__card-button app__card-button--curto">Pausa curto</button>
                    </li>
                    <li class="app__card-list-item">
                        <button data-contexto="long" class="app__card-button app__card-button--longo">Pausa longa</button>
                    </li>
                </ul>
